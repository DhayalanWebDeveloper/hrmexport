export default function HRMExports() {
  return (
    <section className="about-one" style={{
      backgroundImage: "url(https://www.hrmexports.com/assets/images/backgrounds/Ricebg.webp)",
        ...
        <div className="container">
            ...
            <div className="col-xl-4 col-12 d-flex align-items-center">
              <div className="about-one__left">
                <div className="about-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                  <div className="">
                    <img src="https://www.hrmexports.com/assets/images/resources/ricemanu.png" className="img-fluid" alt="HRM Exports"></img>
                  </div>
                  <div className="about-one__experience">
                    <div className="about-one__experience-shape-1">
                      <img src="https://www.hrmexports.com/assets/images/shapes/about-one-experience-shape-1.png" alt="HRM Exports"></img>
                    </div>
                    <div className="about-one__experience-shape-2">
                      <img src="https://www.hrmexports.com/assets/images/shapes/about-one-experience-shape-2.png" alt="HRM Exports"></img>
                    </div>
            ...
            <div className="col-xl-8 col-12">
              <div className="about-one__right">
                <div className="section-title text-left">
                  ...
                  <h2 className="section-title__title wow slideInUp" data-wow-delay="200ms" data-wow-duration="1500ms">HRM Exports</h2>
                  <h1 className="section-title__title wow slideInUp" style={{fontSize: "30px"}} data-wow-delay="200ms" data-wow-duration="1500ms">Rice Manufacturers, Suppliers & Exporters in India</h1>
                </div>                
                <p className="about-one__text-1 wow slideInUp" data-wow-delay="300ms" data-wow-duration="1500ms">Discover the Magic of Rice - Simple, Satisfying, and Versatile</p>
                <p className="about-one__text-2 text-justify wow slideInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
          ...
          <div className="row" style={{paddingTop:"100px"}}>
            <div className="col-xl-8 d-flex align-items-center">
              <div className="">
                <p className="about-one__text-1  wow slideInUp" data-wow-delay="500ms" data-wow-duration="1500ms">Today, we at HRM Exports commit to achieve customer satisfaction with quality, quantity and  services.</p>
                <p className="about-one__text-2 text-justify wow slideInUp" data-wow-delay="600ms" data-wow-duration="1500ms ">We are  delighted to provide consumers fine food with rice of unmatched quality.We work with farmers, partner food companies and respond to the needs of our customers to ensure that nothing but the very best rice and rice products enamor your table, making every meal of the day, fulfilling and cherishing. </p>
                <div className="about-one__btn-box wow slideInUp" data-wow-delay="700ms" data-wow-duration="1500ms">
                  <a href="https://www.hrmexports.com/about" className="about-one__btn thm-btn">Read More</a>
                </div>
              </div>
            </div>
              ...
              <div className="about-one__left about-one__right">
                <div className="about-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                  <div className="about-one__img">
                    <img src="https://www.hrmexports.com/assets/images/resources/quantity.webp" className="img-fluid" alt="HRM Exports"></img>
                  </div>
                  <div className="about-one__img-two">
                    <img src="https://www.hrmexports.com/assets/images/resources/about-three-img-2.jpg" alt="HRM Exports"></img>
                  </div>
                </div>
              </div>
            </div>
